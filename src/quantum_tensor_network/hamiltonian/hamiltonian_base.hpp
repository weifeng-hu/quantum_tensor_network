...
class HamiltonianBase : public quantum_operator :: OperatorBase {
public:
  HamiltonianBase() {}
  HamiltonianBase( const quantum_operator :: OperatorBase& x ) {}
  HamiltonianBase( const HamiltonianBase& x ) {}
public:
   typedef quantum_operator :: OperatorBase base_type;
//public:
