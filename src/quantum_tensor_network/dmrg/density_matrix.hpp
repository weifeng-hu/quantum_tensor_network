...
class DensityMatrix : public tensor :: OpMatrix {
public:
  typedef wavefunction :: RotationMatrix rotation_matrix_type;
  typedef matrix :: EigenpairProcessor eigen_processor_type;
