...
#include "quantum_tensor_network/gradient/soltion_types.hpp"
...
public:
  ...
  typedef gradient :: linear_eigensystem_type :: energy_data_type  energy_data_type;

public:
  this_type( const wavefunction_type& wavefunction_ref,
